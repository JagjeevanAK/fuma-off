      ...
      <div className='w-full bg-[#FFD54F] dark:bg-[#4A4A4A] py-16 flex flex-col items-center'>
        <div className='container px-4 max-w-7xl mx-auto flex flex-col items-center text-center'>
          ...
          <p className='text-xl mb-8 max-w-3xl text-gray-700 dark:text-gray-200'>
            ...
            products from around the world. Browse our API documentation to
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          <div className='bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Access detailed information about food products from around the
              world with our powerful API.
            </p>
          </div>
          <div className='bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md'>
            <h2 className='text-2xl font-bold mb-4 text-gray-800 dark:text-white'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              All data is openly available and can be reused for free under the
          ...
          <div className='bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>
              Join our global community of contributors helping to build the
